...
export ANDROID_HOME="/home/tibbo/Dev/Android/Sdk"
export PATH="${PATH}:~/Dev/Android/Sdk/cmdline-tools/latest/bin"
...
sed -i "/versionDev/,/\}/ s/com.nextcloud.android.beta/local.nextcloud.android.beta/" app/build.gradle
...
./gradlew assembleVersionDevRelease
...
mv ./app/build/outputs/apk/versionDev/release/versionDev-release-$date.apk ./apks/nextcloud-dev-$date.apk
